...
C++ 11 introduced a function name `to_string` that converts a numeric value to a `string` object. There are 9 overloaded version of the `to_string` function listed in **Table 10-6.**
